...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        match tuple {
            (r, g, b) if r > 255 || g > 255 || b > 255 => Err(String::from("Incorrect rgb values ( > 255  )")),
            (r, g, b) if r < 0   || g < 0   || b < 0   => Err(String::from("Incorrect rgb values ( < 0 )")),
            (r, g, b) => Ok(Color {red: r as u8, green: g as u8, blue: b as u8}),
            _ => Err(String::from("Incorrect rgb format")),
        }
    }
}
